...
function getGradeSubjectNames(gradeId) {
  if (gradeId === "e1" || gradeId === "e2") return ["\u56FD\u8A9E", "\u66F8\u5199", "\u7B97\u6570", "\u751F\u6D3B", "\u97F3\u697D", "\u56F3\u5DE5", "\u4F53\u80B2", "\u9053\u5FB3", "\u5B66\u6D3B"];
  if (gradeId.startsWith("e")) return ["\u56FD\u8A9E", "\u66F8\u5199", "\u7B97\u6570", "\u793E\u4F1A", "\u7406\u79D1", "\u97F3\u697D", "\u56F3\u5DE5", "\u4F53\u80B2", "\u5BB6\u5EAD", "\u5916\u56FD\u8A9E", "\u9053\u5FB3", "\u7DCF\u5408", "\u5B66\u6D3B"];
  return ["\u56FD\u8A9E", "\u66F8\u5199", "\u6570\u5B66", "\u82F1\u8A9E", "\u793E\u4F1A", "\u7406\u79D1", "\u97F3\u697D", "\u7F8E\u8853", "\u6280\u8853", "\u5BB6\u5EAD", "\u4F53\u80B2", "\u9053\u5FB3", "\u7DCF\u5408", "\u5B66\u6D3B"];
}
var WEEKLY_ALLOC = {
...
function App() {
  ...
  function handlePickSubject(subjectName) {
    ...
    const newCell = { ...si, teacherId, isEvent: false, isEmpty: false };
  ...
  return /* @__PURE__ */ jsxs("div", { style: S.root, children: [
    ...
    showPicker && selected && /* @__PURE__ */ jsx("div", { style: S.overlay, onClick: (e) => {
      ...
      /* @__PURE__ */ jsx("div", { style: { padding: "16px", overflowY: "auto" }, children: /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "8px" }, children: getGradeSubjectNames(selectedGrade.id).map((sub) => {
