...
function AbsenceModal({ teachers, absences, currentWeekNum, weekDates, onSave, onDelete, onClose }) {
  ...
  const emptyForm = { id: "", teacherId: "", weekNum: currentWeekNum, day: 0, startPeriod: 0, endPeriod: 2, note: "" };
  ...
  function save() {
    ...
    onSave({ ...form, id: form.id || "ab" + Date.now() });
    setEditing(false);
    setForm(emptyForm);
  }
  return /* @__PURE__ */ jsx("div", { style: S.overlay, onClick: (e) => {
      ...
      editing && /* @__PURE__ */ jsxs("div", { style: { background: "#F8F9FA", borderRadius: "14px", padding: "16px", marginTop: "12px", border: "1.5px solid #E8E8E8" }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: "12px" }, children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap", marginTop: "6px" }, children: teachers.map((t) => /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setForm({ ...form, teacherId: t.id }),
              style: {
                padding: "6px 12px",
                borderRadius: "9px",
                border: `2px solid ${form.teacherId === t.id ? t.color : "#E8E8E8"}`,
                background: form.teacherId === t.id ? t.color + "33" : "white",
                color: form.teacherId === t.id ? shadeColor(t.color, -40) : "#888",
                fontWeight: form.teacherId === t.id ? "800" : "400",
                cursor: "pointer",
                fontFamily: "inherit",
                fontSize: "13px"
              },
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(
              "input",
              {
                ...
                max: "52",
                value: form.weekNum,
                onChange: (e) => setForm({ ...form, weekNum: parseInt(e.target.value) || 1 }),
            ...
            /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: "5px", marginTop: "6px" }, children: DAYS.map((d, i) => /* @__PURE__ */ jsx(
              "button",
              {
                ...
                style: {
                  ...
                  height: "36px",
                  borderRadius: "8px",
                  border: `2px solid ${form.day === i ? "#667eea" : "#E8E8E8"}`,
                  background: form.day === i ? "#667eea33" : "white",
                  fontWeight: 700,
                  cursor: "pointer",
                  fontSize: "13px",
                  color: form.day === i ? "#667eea" : "#AAA",
                  fontFamily: "inherit"
                },
                children: d
              },
        ...
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: "12px" }, children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap", marginTop: "6px" }, children: SLOT_PRESETS.map((p, i) => /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setForm({ ...form, startPeriod: p.start, endPeriod: p.end }),
              style: {
                padding: "6px 12px",
                borderRadius: "9px",
                border: `2px solid ${form.startPeriod === p.start && form.endPeriod === p.end ? "#e67e22" : "#E8E8E8"}`,
                background: form.startPeriod === p.start && form.endPeriod === p.end ? "#e67e2222" : "white",
                color: form.startPeriod === p.start && form.endPeriod === p.end ? "#e67e22" : "#888",
                fontWeight: form.startPeriod === p.start && form.endPeriod === p.end ? "800" : "400",
                cursor: "pointer",
                fontFamily: "inherit",
                fontSize: "12px"
              },
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: "8px", alignItems: "center", marginTop: "8px", fontSize: "12px", color: "#888" }, children: [
            /* @__PURE__ */ jsx(
              "select",
              {
                value: form.startPeriod,
                onChange: (e) => setForm({ ...form, startPeriod: parseInt(e.target.value) }),
                style: { padding: "4px 6px", borderRadius: "6px", border: "1.5px solid #E8E8E8", fontFamily: "inherit", fontSize: "12px" },
            ...
            /* @__PURE__ */ jsx(
              "select",
              {
                ...
                onChange: (e) => setForm({ ...form, endPeriod: parseInt(e.target.value) }),
                style: { padding: "4px 6px", borderRadius: "6px", border: "1.5px solid #E8E8E8", fontFamily: "inherit", fontSize: "12px" },
                children: PERIOD_LABELS.map((l, i) => /* @__PURE__ */ jsx("option", { value: i, children: l }, i))
              }
            )
